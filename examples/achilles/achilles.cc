 ...
 */
class AchillesExample : public TrajOptExample {
 public:
  AchillesExample() {
 ...
 private:
  void CreatePlantModel(MultibodyPlant<double>* plant) const {
    ...
    std::string urdf_file =
        FindIdtoResource("idto/models/achilles/achilles_lowered_com_walking_hardware_obj.urdf");
...
int main(int argc, char* argv[]) {
  ...
  idto::examples::achilles::AchillesExample example;
  example.RunExample("idto/examples/achilles/achilles.yaml",
                     FLAGS_test);
